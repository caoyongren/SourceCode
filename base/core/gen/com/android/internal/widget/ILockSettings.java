 ...
 * Original file: /media/matthew/Android-studio/OTOSOURCECODE/base/core/java/com/android/internal/widget/ILockSettings.aidl
 */
...
@Override public void setLockCredential(java.lang.String credential, int type, java.lang.String savedCredential, int userId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public boolean setLockCredentialWithToken(java.lang.String credential, int type, long tokenHandle, byte[] token, int userId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
public void setLockCredential(java.lang.String credential, int type, java.lang.String savedCredential, int userId) throws android.os.RemoteException;
...
public boolean setLockCredentialWithToken(java.lang.String credential, int type, long tokenHandle, byte[] token, int userId) throws android.os.RemoteException;
