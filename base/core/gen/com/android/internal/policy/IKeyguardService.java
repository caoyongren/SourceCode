 ...
 * Original file: /media/matthew/Android-studio/OTOSOURCECODE/base/core/java/com/android/internal/policy/IKeyguardService.aidl
 */
...
@Override public void dismiss(com.android.internal.policy.IKeyguardDismissCallback callback) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
static final int TRANSACTION_onScreenTurningOn = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_onScreenTurnedOn = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_onScreenTurnedOff = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_setKeyguardEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_onSystemReady = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_doKeyguardTimeout = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_setSwitchingUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
...
static final int TRANSACTION_onShortPowerPressedGoHome = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
}
/**
     * Sets the Keyguard as occluded when a window dismisses the Keyguard with flag
     * FLAG_SHOW_ON_LOCK_SCREEN.
