 ...
 * Original file: /media/matthew/Android-studio/OTOSOURCECODE/base/core/java/com/android/internal/view/IInputMethodManager.aidl
 */
...
boolean _arg1;
_arg1 = (0!=data.readInt());
this.reportFullscreenMode(_arg0, _arg1);
reply.writeNoException();
return true;
}
...
@Override public void setImeWindowStatus(android.os.IBinder token, android.os.IBinder startInputToken, int vis, int backDisposition) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void clearLastInputMethodWindowForTransition(android.os.IBinder token) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public com.android.internal.inputmethod.IInputContentUriToken createInputContentUriToken(android.os.IBinder token, android.net.Uri contentUri, java.lang.String packageName) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
@Override public void reportFullscreenMode(android.os.IBinder token, boolean fullscreen) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_finishInput = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
...
static final int TRANSACTION_startInputOrWindowGainedFocus = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_showInputMethodPickerFromClient = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_showInputMethodAndSubtypeEnablerFromClient = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_setInputMethod = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_setInputMethodAndSubtype = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_hideMySoftInput = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_showMySoftInput = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_updateStatusIcon = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_setImeWindowStatus = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_registerSuggestionSpansForNotification = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_notifySuggestionPicked = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_getCurrentInputMethodSubtype = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_setCurrentInputMethodSubtype = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_switchToLastInputMethod = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_switchToNextInputMethod = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_shouldOfferSwitchingToNextInputMethod = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
...
static final int TRANSACTION_getInputMethodWindowVisibleHeight = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_clearLastInputMethodWindowForTransition = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_createInputContentUriToken = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_reportFullscreenMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
static final int TRANSACTION_notifyUserAction = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
}
// TODO: Use ParceledListSlice instead
...
public void setImeWindowStatus(android.os.IBinder token, android.os.IBinder startInputToken, int vis, int backDisposition) throws android.os.RemoteException;
...
public void clearLastInputMethodWindowForTransition(android.os.IBinder token) throws android.os.RemoteException;
public com.android.internal.inputmethod.IInputContentUriToken createInputContentUriToken(android.os.IBinder token, android.net.Uri contentUri, java.lang.String packageName) throws android.os.RemoteException;
public void reportFullscreenMode(android.os.IBinder token, boolean fullscreen) throws android.os.RemoteException;
