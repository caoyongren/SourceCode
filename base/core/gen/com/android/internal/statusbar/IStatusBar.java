 ...
 * Original file: /media/matthew/Android-studio/OTOSOURCECODE/base/core/java/com/android/internal/statusbar/IStatusBar.aidl
 */
...
static final int TRANSACTION_showRecentApps = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_hideRecentApps = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_toggleRecentApps = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_toggleSplitScreen = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
...
static final int TRANSACTION_showScreenPinningRequest = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_dismissKeyboardShortcutsMenu = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_toggleKeyboardShortcutsMenu = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
...
static final int TRANSACTION_appTransitionFinished = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_showAssistDisclosure = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_startAssist = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_onCameraLaunchGestureDetected = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_showPictureInPictureMenu = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_showGlobalActionsMenu = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_addQsTile = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_remQsTile = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_clickQsTile = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_handleSystemNavigationKey = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
}
