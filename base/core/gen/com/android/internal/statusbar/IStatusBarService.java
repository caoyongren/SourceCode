 ...
 * Original file: /media/matthew/Android-studio/OTOSOURCECODE/base/core/java/com/android/internal/statusbar/IStatusBarService.aidl
 */
...
@Override public void handleSystemNavigationKey(int key) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_setIcon = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_setIconVisibility = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_removeIcon = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_setImeWindowStatus = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_expandSettingsPanel = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_registerStatusBar = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_onPanelRevealed = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_onPanelHidden = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_clearNotificationEffects = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_onNotificationClick = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_onNotificationActionClick = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_onNotificationError = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_onClearAllNotifications = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_onNotificationClear = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_onNotificationVisibilityChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_onNotificationExpansionChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_setSystemUiVisibility = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_onGlobalActionsShown = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_onGlobalActionsHidden = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_shutdown = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_reboot = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_addTile = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_remTile = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_clickTile = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_handleSystemNavigationKey = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
}
...
public void handleSystemNavigationKey(int key) throws android.os.RemoteException;
}
