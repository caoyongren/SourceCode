 ...
 * Original file: /media/matthew/Android-studio/OTOSOURCECODE/base/core/java/android/net/IIpSecService.aidl
 */
package android.net;
/**
 * @hide
...
@Override public android.os.Bundle reserveSecurityParameterIndex(int direction, java.lang.String remoteAddress, int requestedSpi, android.os.IBinder binder) throws android.os.RemoteException
{
...
@Override public android.os.Bundle openUdpEncapsulationSocket(int port, android.os.IBinder binder) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
android.os.Bundle _result;
...
@Override public void closeUdpEncapsulationSocket(android.os.ParcelFileDescriptor socket) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public android.os.Bundle createTransportModeTransform(android.net.IpSecConfig c, android.os.IBinder binder) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
android.os.Bundle _result;
...
public android.os.Bundle reserveSecurityParameterIndex(int direction, java.lang.String remoteAddress, int requestedSpi, android.os.IBinder binder) throws android.os.RemoteException;
public void releaseSecurityParameterIndex(int resourceId) throws android.os.RemoteException;
public android.os.Bundle openUdpEncapsulationSocket(int port, android.os.IBinder binder) throws android.os.RemoteException;
public void closeUdpEncapsulationSocket(android.os.ParcelFileDescriptor socket) throws android.os.RemoteException;
public android.os.Bundle createTransportModeTransform(android.net.IpSecConfig c, android.os.IBinder binder) throws android.os.RemoteException;
