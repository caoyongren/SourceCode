 ...
 * Original file: /media/matthew/Android-studio/OTOSOURCECODE/base/core/java/android/net/IConnectivityManager.aidl
 */
package android.net;
/**
...
@Override public void startTethering(int type, android.os.ResultReceiver receiver, boolean showProvisioningUi) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void stopTethering(int type) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public com.android.internal.net.VpnInfo[] getAllVpnInfo() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
@Override public boolean setAlwaysOnVpnPackage(int userId, java.lang.String packageName, boolean lockdown) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
@Override public int registerNetworkAgent(android.os.Messenger messenger, android.net.NetworkInfo ni, android.net.LinkProperties lp, android.net.NetworkCapabilities nc, int score, android.net.NetworkMisc misc) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
mRemote.transact(Stub.TRANSACTION_startCaptivePortalApp, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
mRemote.transact(Stub.TRANSACTION_getMultipathPreference, _data, _reply, 0);
_reply.readException();
_result = _reply.readInt();
}
finally {
...
@Override public void startNattKeepalive(android.net.Network network, int intervalSeconds, android.os.Messenger messenger, android.os.IBinder binder, java.lang.String srcAddr, int srcPort, java.lang.String dstAddr) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_getAllVpnInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 44);
static final int TRANSACTION_updateLockdownVpn = (android.os.IBinder.FIRST_CALL_TRANSACTION + 45);
...
static final int TRANSACTION_checkMobileProvisioning = (android.os.IBinder.FIRST_CALL_TRANSACTION + 48);
static final int TRANSACTION_getMobileProvisioningUrl = (android.os.IBinder.FIRST_CALL_TRANSACTION + 49);
static final int TRANSACTION_setProvisioningNotificationVisible = (android.os.IBinder.FIRST_CALL_TRANSACTION + 50);
static final int TRANSACTION_setAirplaneMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 51);
static final int TRANSACTION_registerNetworkFactory = (android.os.IBinder.FIRST_CALL_TRANSACTION + 52);
static final int TRANSACTION_requestBandwidthUpdate = (android.os.IBinder.FIRST_CALL_TRANSACTION + 53);
static final int TRANSACTION_unregisterNetworkFactory = (android.os.IBinder.FIRST_CALL_TRANSACTION + 54);
static final int TRANSACTION_registerNetworkAgent = (android.os.IBinder.FIRST_CALL_TRANSACTION + 55);
static final int TRANSACTION_requestNetwork = (android.os.IBinder.FIRST_CALL_TRANSACTION + 56);
static final int TRANSACTION_pendingRequestForNetwork = (android.os.IBinder.FIRST_CALL_TRANSACTION + 57);
static final int TRANSACTION_releasePendingNetworkRequest = (android.os.IBinder.FIRST_CALL_TRANSACTION + 58);
...
static final int TRANSACTION_setAcceptUnvalidated = (android.os.IBinder.FIRST_CALL_TRANSACTION + 62);
static final int TRANSACTION_setAvoidUnvalidated = (android.os.IBinder.FIRST_CALL_TRANSACTION + 63);
static final int TRANSACTION_startCaptivePortalApp = (android.os.IBinder.FIRST_CALL_TRANSACTION + 64);
static final int TRANSACTION_getMultipathPreference = (android.os.IBinder.FIRST_CALL_TRANSACTION + 65);
static final int TRANSACTION_getRestoreDefaultNetworkDelay = (android.os.IBinder.FIRST_CALL_TRANSACTION + 66);
static final int TRANSACTION_addVpnAddress = (android.os.IBinder.FIRST_CALL_TRANSACTION + 67);
static final int TRANSACTION_removeVpnAddress = (android.os.IBinder.FIRST_CALL_TRANSACTION + 68);
static final int TRANSACTION_setUnderlyingNetworksForVpn = (android.os.IBinder.FIRST_CALL_TRANSACTION + 69);
static final int TRANSACTION_factoryReset = (android.os.IBinder.FIRST_CALL_TRANSACTION + 70);
static final int TRANSACTION_startNattKeepalive = (android.os.IBinder.FIRST_CALL_TRANSACTION + 71);
static final int TRANSACTION_stopKeepalive = (android.os.IBinder.FIRST_CALL_TRANSACTION + 72);
static final int TRANSACTION_getCaptivePortalServerUrl = (android.os.IBinder.FIRST_CALL_TRANSACTION + 73);
}
...
public void startTethering(int type, android.os.ResultReceiver receiver, boolean showProvisioningUi) throws android.os.RemoteException;
public void stopTethering(int type) throws android.os.RemoteException;
...
public boolean setAlwaysOnVpnPackage(int userId, java.lang.String packageName, boolean lockdown) throws android.os.RemoteException;
...
public int registerNetworkAgent(android.os.Messenger messenger, android.net.NetworkInfo ni, android.net.LinkProperties lp, android.net.NetworkCapabilities nc, int score, android.net.NetworkMisc misc) throws android.os.RemoteException;
...
public void startNattKeepalive(android.net.Network network, int intervalSeconds, android.os.Messenger messenger, android.os.IBinder binder, java.lang.String srcAddr, int srcPort, java.lang.String dstAddr) throws android.os.RemoteException;
