 ...
 * Original file: /media/matthew/Android-studio/OTOSOURCECODE/base/core/java/android/net/INetworkStatsService.aidl
 */
package android.net;
/** {@hide} */
...
/** Start a statistics query session. If calling package is profile or device owner then it is
     ...
     */
@Override public android.net.INetworkStatsSession openSessionForUsageStats(java.lang.String callingPackage) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
android.net.INetworkStatsSession _result;
...
static final int TRANSACTION_getNetworkTotalBytes = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_getDataLayerSnapshotForUid = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
...
static final int TRANSACTION_forceUpdateIfaces = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_forceUpdate = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_advisePersistThreshold = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_registerUsageCallback = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_unregisterUsageRequest = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
}
/** Start a statistics query session. */
...
/** Start a statistics query session. If calling package is profile or device owner then it is
     ...
     *  READ_NETWORK_USAGE_STATS is checked for.
     */
public android.net.INetworkStatsSession openSessionForUsageStats(java.lang.String callingPackage) throws android.os.RemoteException;
/** Return network layer usage total for traffic that matches template. */
