 ...
 * Original file: /media/matthew/Android-studio/OTOSOURCECODE/base/core/java/android/view/autofill/IAutoFillManagerClient.aidl
 */
...
/**
     ...
     */
@Override public void notifyNoFillUi(int sessionId, android.view.autofill.AutofillId id) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
/**
     ...
     */
@Override public void startIntentSender(android.content.IntentSender intentSender) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
/**
     * Notifies no fill UI will be shown.
     */
public void notifyNoFillUi(int sessionId, android.view.autofill.AutofillId id) throws android.os.RemoteException;
/**
     * Starts the provided intent sender
     */
public void startIntentSender(android.content.IntentSender intentSender) throws android.os.RemoteException;
}
