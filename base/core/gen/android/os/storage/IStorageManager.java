 ...
 * Original file: /media/matthew/Android-studio/OTOSOURCECODE/base/core/java/android/os/storage/IStorageManager.aidl
 */
...
@Override public long getAllocatableBytes(java.lang.String volumeUuid, int flags) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
long _result;
...
@Override public void allocateBytes(java.lang.String volumeUuid, long bytes, int flags) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
public long getAllocatableBytes(java.lang.String volumeUuid, int flags) throws android.os.RemoteException;
public void allocateBytes(java.lang.String volumeUuid, long bytes, int flags) throws android.os.RemoteException;
