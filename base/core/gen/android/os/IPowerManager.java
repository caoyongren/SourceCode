 ...
 * Original file: /media/matthew/Android-studio/OTOSOURCECODE/base/core/java/android/os/IPowerManager.aidl
 */
package android.os;
/** @hide */
...
@Override public void wakeUp(long time, java.lang.String reason, java.lang.String opPackageName) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_setPowerSaveMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_isDeviceIdleMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_isLightDeviceIdleMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_reboot = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_rebootSafeMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_shutdown = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_crash = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_getLastShutdownReason = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_setStayOnSetting = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_boostScreenBrightness = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_isScreenBrightnessBoosted = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_setTemporaryScreenBrightnessSettingOverride = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_setTemporaryScreenAutoBrightnessAdjustmentSettingOverride = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_setAttentionLight = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
}
// WARNING: When methods are inserted or deleted, the transaction IDs in
// frameworks/native/include/powermanager/IPowerManager.h must be updated to match the order in this file.
//
...
public void wakeUp(long time, java.lang.String reason, java.lang.String opPackageName) throws android.os.RemoteException;
