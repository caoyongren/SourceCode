 ...
 * Original file: /media/matthew/Android-studio/OTOSOURCECODE/base/core/java/android/nfc/INfcAdapter.aidl
 */
package android.nfc;
/**
 * @hide
...
static final int TRANSACTION_enable = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_enableNdefPush = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_disableNdefPush = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_isNdefPushEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_pausePolling = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_resumePolling = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_setForegroundDispatch = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_setAppCallback = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_invokeBeam = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_invokeBeamInternal = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_ignore = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_dispatch = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_setReaderMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_setP2pModes = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_addNfcUnlockHandler = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_removeNfcUnlockHandler = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_verifyNfcPermission = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
}
