 ...
 * Original file: /media/matthew/Android-studio/OTOSOURCECODE/base/core/java/android/content/pm/IOnAppsChangedListener.aidl
 */
...
@Override public void onPackagesSuspended(android.os.UserHandle user, java.lang.String[] packageNames) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
public void onPackagesSuspended(android.os.UserHandle user, java.lang.String[] packageNames) throws android.os.RemoteException;
