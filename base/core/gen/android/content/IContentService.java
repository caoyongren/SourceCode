 ...
 * Original file: /media/matthew/Android-studio/OTOSOURCECODE/base/core/java/android/content/IContentService.aidl
 */
...
int _arg5;
_arg5 = data.readInt();
this.notifyChange(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5);
reply.writeNoException();
return true;
}
...
/**
     ...
     */
@Override public void notifyChange(android.net.Uri uri, android.database.IContentObserver observer, boolean observerWantsSelfNotifications, int flags, int userHandle, int targetSdkVersion) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_getSyncAdapterPackagesForAuthorityAsUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_isSyncActive = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_getSyncStatus = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_getSyncStatusAsUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_isSyncPending = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
static final int TRANSACTION_isSyncPendingAsUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
static final int TRANSACTION_addStatusChangeListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
static final int TRANSACTION_removeStatusChangeListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
static final int TRANSACTION_putCache = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
static final int TRANSACTION_getCache = (android.os.IBinder.FIRST_CALL_TRANSACTION + 36);
}
...
/**
     ...
     *     USER_CURRENT are properly interpreted.
     */
public void notifyChange(android.net.Uri uri, android.database.IContentObserver observer, boolean observerWantsSelfNotifications, int flags, int userHandle, int targetSdkVersion) throws android.os.RemoteException;
