 ...
 * Original file: /media/matthew/Android-studio/OTOSOURCECODE/base/core/java/android/service/vr/IVrManager.aidl
 */
...
static final int TRANSACTION_setPersistentVrModeEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_setVr2dDisplayProperties = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_getVr2dDisplayId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
}
/**
     * Add a callback to be notified when VR mode state changes.
     *
