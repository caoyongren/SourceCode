 ...
 * Original file: /media/matthew/Android-studio/OTOSOURCECODE/base/core/java/android/app/ITaskStackListener.aidl
 */
package android.app;
/** @hide */
...
@Override public void onActivityPinned(java.lang.String packageName, int taskId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
/** Called whenever an Activity is moved to the pinned stack from another stack. */
public void onActivityPinned(java.lang.String packageName, int taskId) throws android.os.RemoteException;
/** Called whenever an Activity is moved from the pinned stack to another stack. */
