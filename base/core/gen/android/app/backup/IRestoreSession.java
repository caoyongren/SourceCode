 ...
 * Original file: /media/matthew/Android-studio/OTOSOURCECODE/base/core/java/android/app/backup/IRestoreSession.aidl
 */
...
@Override public int restoreSome(long token, android.app.backup.IRestoreObserver observer, android.app.backup.IBackupManagerMonitor monitor, java.lang.String[] packages) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
public int restoreSome(long token, android.app.backup.IRestoreObserver observer, android.app.backup.IBackupManagerMonitor monitor, java.lang.String[] packages) throws android.os.RemoteException;
