 ...
 * Original file: /media/matthew/Android-studio/OTOSOURCECODE/base/core/java/android/app/backup/IBackupManager.aidl
 */
...
/**
     ...
     */
@Override public void adbBackup(android.os.ParcelFileDescriptor fd, boolean includeApks, boolean includeObbs, boolean includeShared, boolean doWidgets, boolean allApps, boolean allIncludesSystem, boolean doCompress, boolean doKeyValue, java.lang.String[] packageNames) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
     ...
     * <p>Callers must hold the android.permission.BACKUP permission to use this method.
     */
@Override public void adbRestore(android.os.ParcelFileDescriptor fd) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public android.content.ComponentName[] listAllTransportComponents() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
/**
     ...
     * @hide
     */
@Override public void selectBackupTransportAsync(android.content.ComponentName transport, android.app.backup.ISelectBackupTransportCallback listener) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
     ...
     */
@Override public long getAvailableRestoreToken(java.lang.String packageName) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
long _result;
...
/**
     ...
     */
@Override public boolean isAppEligibleForBackup(java.lang.String packageName) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
static final int TRANSACTION_adbBackup = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_fullTransportBackup = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_adbRestore = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
...
static final int TRANSACTION_listAllTransportComponents = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_getTransportWhitelist = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_selectBackupTransport = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_selectBackupTransportAsync = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_getConfigurationIntent = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_getDestinationString = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_getDataManagementIntent = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_getDataManagementLabel = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_beginRestoreSession = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_opComplete = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_setBackupServiceActive = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_isBackupServiceActive = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_getAvailableRestoreToken = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_isAppEligibleForBackup = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
static final int TRANSACTION_requestBackup = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
static final int TRANSACTION_cancelBackups = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
}
/**
     * Tell the system service that the caller has made changes to its
     * data, and therefore needs to undergo an incremental backup pass.
...
/**
     ...
     * @return Whether this app is eligible for backup.
     */
public boolean isAppEligibleForBackup(java.lang.String packageName) throws android.os.RemoteException;
