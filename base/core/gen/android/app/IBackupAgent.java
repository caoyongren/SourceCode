 ...
 * Original file: /media/matthew/Android-studio/OTOSOURCECODE/base/core/java/android/app/IBackupAgent.aidl
 */
package android.app;
/**
...
int _arg4;
_arg4 = data.readInt();
android.app.backup.IBackupManager _arg5;
_arg5 = android.app.backup.IBackupManager.Stub.asInterface(data.readStrongBinder());
...
this.doFullBackup(_arg0, _arg1, _arg2, _arg3);
return true;
}
...
this.doMeasureFullBackup(_arg0, _arg1, _arg2);
return true;
}
...
/**
     ...
     */
@Override public void doBackup(android.os.ParcelFileDescriptor oldState, android.os.ParcelFileDescriptor data, android.os.ParcelFileDescriptor newState, long quotaBytes, int token, android.app.backup.IBackupManager callbackBinder) throws android.os.RemoteException
{
...
/**
     ...
     *        passed here as a convenience to the agent.
     */
@Override public void doFullBackup(android.os.ParcelFileDescriptor data, long quotaBytes, int token, android.app.backup.IBackupManager callbackBinder) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
/**
     ...
     */
@Override public void doMeasureFullBackup(long quotaBytes, int token, android.app.backup.IBackupManager callbackBinder) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
/**
     ...
     */
@Override public void doQuotaExceeded(long backupDataBytes, long quotaBytes) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
/**
     ...
     *        passed here as a convenience to the agent.
     */
public void doBackup(android.os.ParcelFileDescriptor oldState, android.os.ParcelFileDescriptor data, android.os.ParcelFileDescriptor newState, long quotaBytes, int token, android.app.backup.IBackupManager callbackBinder) throws android.os.RemoteException;
/**
     * Restore an entire data snapshot to the application.
     *
     * @param data Read-only file containing the full data snapshot of the
...
/**
     ...
     *        passed here as a convenience to the agent.
     */
public void doFullBackup(android.os.ParcelFileDescriptor data, long quotaBytes, int token, android.app.backup.IBackupManager callbackBinder) throws android.os.RemoteException;
/**
     * Estimate how much data a full backup will deliver
     */
public void doMeasureFullBackup(long quotaBytes, int token, android.app.backup.IBackupManager callbackBinder) throws android.os.RemoteException;
/**
     * Tells the application agent that the backup data size exceeded current transport quota.
     * Later calls to {@link #onBackup(ParcelFileDescriptor, BackupDataOutput, ParcelFileDescriptor)}
     * and {@link #onFullBackup(FullBackupDataOutput)} could use this information
     ...
     * @param quotaBytes Current amount of backup data that is allowed for the app.
     */
public void doQuotaExceeded(long backupDataBytes, long quotaBytes) throws android.os.RemoteException;
/**
     * Restore a single "file" to the application.  The file was typically obtained from
     * a full-backup dataset.  The agent reads 'size' bytes of file content
     * from the provided file descriptor.
