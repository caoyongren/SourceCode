 ...
 * Original file: /media/matthew/Android-studio/OTOSOURCECODE/base/core/java/android/app/IActivityContainer.aidl
 */
package android.app;
/** @hide */
...
@Override public void addToDisplay(int displayId) throws android.os.RemoteException
{
...
@Override public int getStackId() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getStackId, _data, _reply, 0);
_reply.readException();
_result = _reply.readInt();
}
finally {
...
static final int TRANSACTION_getDisplayId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_getStackId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_injectEvent = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_release = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
}
public void addToDisplay(int displayId) throws android.os.RemoteException;
